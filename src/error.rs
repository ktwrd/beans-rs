...
pub enum BeansError {
    ...
    FreeSpaceCheckFailure { location: String },
    ...
    LatestVersionAlreadyInstalled { current: usize, latest: usize },
    #[error("Failed to download file\n{reason:#?}")]
    DownloadFailure { reason: DownloadFailureReason },
    ...
    RemoteVersionNotFound { version: Option<usize> },
